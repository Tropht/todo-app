...
}s(r)}}}var s=t.module("ngRoute",["ng"]).provider("$route",r),u=t.$$minErr("ngRoute");s.provider("$routeParams",i),s.directive("ngView",o),s.directive("ngView",a),o.$inject=["$route","$anchorScroll","$animate"],a.$inject=["$compile","$controller","$route"]}(window,window.angular),angular.module("TodoApp",["ngRoute","LoginController"]).config(["$routeProvider",function(e){"use strict";e.when("/login",{templateUrl:"/partials/login-controller.html",controller:"LoginController"}).otherwise("/login")}]),angular.module("LoginController",[]).controller("LoginController",[function(){"use strict"}]);
